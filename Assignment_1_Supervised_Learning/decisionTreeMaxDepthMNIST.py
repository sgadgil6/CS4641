#source of dataset https://www.kaggle.com/jmohitj/practicing-playing-with-mnist-decision-tree/notebook
import numpy as np
import pandas as pd
...
df.to_csv(r'decisionTreeOutputMaxDepthMNIST.csv', index=None, header=True)
