...
for i in range(18, 0, -1):
    x_train, _, y_train, _ = train_test_split(x, y, test_size=round(0.05,2), random_state=42)
    ...
    print(metrics.confusion_matrix(y_test, y_predicted).ravel())
...
# df.to_csv(r'svmBreastCancerTest.csv', index=None, header=True)
